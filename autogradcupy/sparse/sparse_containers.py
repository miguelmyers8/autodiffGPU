...
from autogradcupy import cupy_wrapper as acp

_container.__array_priority__ = 90.0


# Define a general box for a sparse array.
class SparseArraycontainer(_container):
    __slots__ = []
...
SparseArraycontainer.register(cpx.scipy.sparse.dia_matrix)
SparseArraycontainer.register(cpx.scipy.sparse.csr_matrix)
SparseArraycontainer.register(cpx.scipy.sparse.coo_matrix)
SparseArraycontainer.register(cpx.scipy.sparse.csc_matrix)
...
for type_ in [
    ...
    SparseArraycontainer.register(type_)
